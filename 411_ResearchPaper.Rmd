...
Step 6: Encrypt the message using $C\equiv M^e(modn)$ to calculate the least residue $(modn)$.

Step 7: Decrypt the message using $M\equiv C^d(modn)$ to calculate the least residue $(modn)$.
